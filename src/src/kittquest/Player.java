...
public class Player {
    ...
    private static final Color[] BODY_COLORS   = {new Color(255,165,0), new Color(140,140,170), new Color(240,240,255)};
    private static final Color[] STRIPE_COLORS = {new Color(220,130,0), new Color(100,100,130), new Color(200,200,220)};
    private static final Color[] TAIL_COLORS   = {new Color(255,140,0), new Color(120,120,150), new Color(210,210,230)};
    ...
    public void draw(Graphics2D g) {
        ...
        int c  = GamePanel.selectedCharacter;

        Color bodyColor   = BODY_COLORS[c];
        Color stripeColor = STRIPE_COLORS[c];
        Color tailColor   = TAIL_COLORS[c];
